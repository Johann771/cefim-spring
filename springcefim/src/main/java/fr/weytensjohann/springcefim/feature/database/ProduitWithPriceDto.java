...
public class ProduitWithPriceDto extends ProduitDto{
    ...
    public ProduitWithPriceDto(Tuple tuple) {
        ...
        Object unitPriceObject = tuple.get(3);
        if (unitPriceObject instanceof Double) {
            this.unitPrice = BigDecimal.valueOf((Double) unitPriceObject);
        } else if (unitPriceObject instanceof Integer) {
            this.unitPrice = BigDecimal.valueOf(((Integer) unitPriceObject).doubleValue());
        } else {
